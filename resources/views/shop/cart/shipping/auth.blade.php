        ...
        <section class="flex flex-col p-8 rounded-xl border border-dashed border-primary-400 ">
            ...
            <div class="relative border border-primary-400 p-4 rounded-sm w-full flex flex-col space-y-2">
                <h3 class="absolute -top-3 py-1 px-4 bg-primary-100 uppercase text-sm flex items-center">
                    ...
                    Adresse selectionnée <strong class="ml-1">{{ \Str::limit($user->address->name, 30, '') }}</strong>
                </h3>

                <div class="hidden sm:flex absolute top-4 right-2 opacity-75 md:flex-col">
                ...
                <article class="px-3 pb-3 pt-8 md:pt-3 flex items-center flex-wrap rounded">
            ...
            @if (!$user->address->is_billing)
                ...
                @endphp
                <div class="relative border border-primary-400 p-4 rounded-sm w-full flex flex-col space-y-2 mt-12 md:mt-6">
                    <h3 class="absolute -top-3 py-1 px-4 bg-primary-100 uppercase text-sm flex items-center">
                        <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" />
                        </svg>
                        Adresse selectionnée <strong class="ml-1">{{ \Str::limit($address->name, 30, '') }}</strong>
                    </h3>
