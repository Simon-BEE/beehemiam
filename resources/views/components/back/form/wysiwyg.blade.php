    ...
    <div class="toolbar">
        <div class="flex flex-wrap justify-center items-center space-x-2 mb-1 text-gray-700 dark:text-gray-400">
            <div class="format-category">
                <button type="button" class="editor-button p-2 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 text-center" data-action="bold" title="Bold">
                ...
                <button type="button" class="editor-button p-2 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 text-center" data-action="italic" title="Italic">
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M10,4V7H12.21L8.79,15H6V18H14V15H11.79L15.21,7H18V4H10Z" />
                    </svg>
                </button>
                <button type="button" class="editor-button p-2 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 text-center" data-action="underline" title="Underline">
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
            ...
            <div class="format-category">
                <button type="button" class="editor-button p-2 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 text-center" data-action="insertUnorderedList" title="Insert list">
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
            ...
            <div class="format-category">
                <button type="button" class="editor-button p-2 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 text-center" data-action="insertHorizontalRule" title="Insert horizontal rule">
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
            ...
            <div class="format-category">
                <button type="button" class="editor-button p-2 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 text-center" data-action="undo" title="Undo">
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
                ...
                <button type="button" class="editor-button p-2 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 text-center" data-action="removeFormat" title="Remove format">
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
            ...
            <div class="format-category">
                <button type="button" class="editor-button p-2 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 text-center" data-action="createLink" title="Insert Link">
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M3.9,12C3.9,10.29 5.29,8.9 7,8.9H11V7H7A5,5 0 0,0 2,12A5,5 0 0,0 7,17H11V15.1H7C5.29,15.1 3.9,13.71 3.9,12M8,13H16V11H8V13M17,7H13V8.9H17C18.71,8.9 20.1,10.29 20.1,12C20.1,13.71 18.71,15.1 17,15.1H13V17H17A5,5 0 0,0 22,12A5,5 0 0,0 17,7Z" />
                    </svg>
                </button>
                <button type="button" class="editor-button p-2 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 text-center" data-action="unlink" title="Unlink">
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
            ...
            <div class="format-category">
                <button type="button" class="editor-button p-2 rounded cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800 text-center" data-action="code" title="Show HTML-Code">
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
