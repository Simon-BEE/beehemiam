...
<body>
    ...
    <main class="w-screen min-h-screen py-4 flex justify-center items-center relative auth-pattern">
        ...
        <div class="absolute top-2 left-3">
            <a href="{{ route('welcome') }}" class="p-3 flex items-center text-sm uppercase font-bold text-kaki-800 hover:text-kaki-900 hover:bg-gray-100">
        ...
        <section class="flex flex-col items-center md:flex-row w-10/12 md:w-1/2 bg-white text-kaki-900 rounded-2xl shadow-lg mt-16 md:mt-0">
            @yield('content')
        </section>
    </main>
