<div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul class="mt-6">
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.dashboard') ? '<span class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.categories.*') ? '<span class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.products.*') ? '<span class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.orders.*') ? '<span class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.discount.*') ? '<span class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.transactions.*') ? '<span class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.messages.*') ? '<span class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
