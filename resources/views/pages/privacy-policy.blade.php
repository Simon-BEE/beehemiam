...
<section class="flex flex-col items-center justify-center p-4 md:p-0">
    ...
    <section class="w-full flex flex-col space-y-5">
        ...
        <article>
            <h2 class="text-xl font-bold mb-2 uppercase">1. Qui sommes-nous ?</h2>
        ...
        <article>
            <h2 class="text-xl font-bold mb-2 uppercase">2. Utilisation des données personnelles collectées</h2>

            <h3 class="text-lg font-semibold mb-2">2.1 Statistiques et mesures d’audience</h3>
            ...
            <h3 class="text-lg font-semibold mb-2">2.2 État du suivi de votre navigation</h3>
            ...
            <h3 class="text-lg font-semibold mb-2">2.3 Formulaires de contact</h3>
            ...
            <h3 class="text-lg font-semibold mb-2">2.4 Contenu embarqué depuis d’autres sites</h3>
            ...
            <h3 class="text-lg font-semibold mb-2">2.5 Publicité</h3>
        ...
        <article>
            <h2 class="text-xl font-bold mb-2 uppercase">3. Cookies</h2>
        ...
        <article>
            <h2 class="text-xl font-bold mb-2 uppercase">4. Les droits que vous avez sur vos données</h2>
        ...
        <article>
            <h2 class="text-xl font-bold mb-2 uppercase">5. Consentement</h2>

            <p class="mb-1">En utilisant ce site, vous consentez à notre politique de confidentialité.</p>
        </article>

        <article>
            <h2 class="text-xl font-bold mb-2 uppercase">6. Informations de contact</h2>
