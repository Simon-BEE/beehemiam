...
@section('content')
    <div class="container grid px-6 mx-auto">
            ...
            <x-form.form action="{{ $product->updateRoute }}" method="PATCH" id="editProductForm">
                ...
                <div class="flex flex-col mt-4 ml-2 space-y-4">
                    <x-back.form.switch 
                        ...
                        {{-- onchange="addQuantityField(this)" --}}
                    >
        ...
        <div class="px-4 py-3 mb-20 bg-white rounded-lg shadow-md dark:bg-gray-800">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Culpa, impedit in. Impedit similique, inventore autem at voluptatum assumenda sequi quidem itaque. Dolor corporis dicta soluta eaque, in aliquid minima culpa!
        </div>
