<div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul class="mt-6">
        ...
        <li class="relative px-6 py-3">
            ...
            <a data-turbolinks-action="replace" class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->routeIs('admin.categories.*') ? 'dark:text-gray-100 text-gray-800' : '' }}" href="#">
        ...
        <li class="relative px-6 py-3">
            ...
            <a data-turbolinks-action="replace" class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->routeIs('admin.products.*') ? 'dark:text-gray-100 text-gray-800' : '' }}" href="#">
                <svg class="w-5 h-5" viewBox="0 0 24 24">
        ...
        <li class="relative px-6 py-3">
            ...
            <a data-turbolinks-action="replace" class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->routeIs('admin.orders.*') ? 'dark:text-gray-100 text-gray-800' : '' }}" href="#">
                <svg class="w-5 h-5" viewBox="0 0 24 24">
        ...
        <li class="relative px-6 py-3">
            ...
            <a data-turbolinks-action="replace" class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->routeIs('admin.discount.*') ? 'dark:text-gray-100 text-gray-800' : '' }}" href="#">
                <svg class="w-5 h-5" viewBox="0 0 24 24">
        ...
        <li class="relative px-6 py-3">
            {!! request()->routeIs('admin.payments.*') ? '<span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>' : '' !!}
            <a data-turbolinks-action="replace" class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->routeIs('admin.payments.*') ? 'dark:text-gray-100 text-gray-800' : '' }}" href="#">
                <svg class="w-5 h-5" viewBox="0 0 24 24">
