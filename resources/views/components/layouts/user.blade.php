<section class="flex flex-col md:flex-row items-start">
    <aside class="w-full md:w-1/4 bg-primary-300 pt-5 px-5 pb-32">
        <ul class="flex flex-col space-y-1">
            ...
            <li>
                <a href="#" class="flex items-center px-2 py-3 transition-colors duration-300 font-semibold rounded-sm {{ request()->routeIs('user.profile.password') ? 'bg-primary-700' : '' }} hover:bg-primary-700">
                    <svg class="w-5 h-5 mr-4" viewBox="0 0 24 24">
            ...
            <li>
                <a href="#" class="flex items-center px-2 py-3 transition-colors duration-300 font-semibold rounded-sm {{ request()->routeIs('user.profile.addresses.*') ? 'bg-primary-700' : '' }} hover:bg-primary-700">
                    <svg class="w-5 h-5 mr-4" viewBox="0 0 24 24">
            ...
            <li>
                <a href="#" class="flex items-center px-2 py-3 transition-colors duration-300 font-semibold rounded-sm {{ request()->routeIs('user.profile.orders.*') ? 'bg-primary-700' : '' }} hover:bg-primary-700">
                    <svg class="w-5 h-5 mr-4" viewBox="0 0 24 24">
