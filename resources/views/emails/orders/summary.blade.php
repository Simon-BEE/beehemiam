...
@section('content')
    ...
    <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">Cette commande n°{{ $order->id }} d'un montant de {{ $order->formatted_price }}€ est en cours de préparation. Vous recevrez un email dès lors que celle-ci sera expédiée.</p>
