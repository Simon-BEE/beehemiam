<template>
    <table class="w-full whitespace-nowrap">
        ...
        <tbody>
            ...
            <tr v-for="product in products" :key="product.id" v-else-if="products.length && !loading">
                ...
                <td>
                    <button @click="removeProduct(product.id)" class="flex justify-center text-red-400 hover:bg-primary-200 rounded p-1" title="Supprimer du panier">
