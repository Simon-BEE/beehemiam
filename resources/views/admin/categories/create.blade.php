...
@section('content')
    <div class="container grid px-6 mx-auto">
        ...
        <section class="breadcrumb my-6 flex items-center flex-wrap space-x-2 text-gray-600 dark:text-gray-400">
            ...
            <a href="#" class="hover:text-gray-700 dark:hover:text-gray-100">Voir toutes les catégories</a>
            <span class="text-gray-500">/</span>
            <p>Ajouter une nouvelle catégorie de vêtements</p>
        </section>
        ...
        <div class="px-4 py-3 mb-20 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <x-form.form action="{{ route('admin.categories.store') }}" method="POST" files>
                ...
                <x-back.form.wysiwyg name="description" label="{{ __('Description de la catégorie') }}" />
