...
<div class="{{ $classDiv ?? 'flex flex-wrap mb-4' }}">
    <label 
        class="w-full flex flex-col items-center px-4 py-6 bg-white dark:bg-gray-800 text-gray-500 rounded-lg shadow-lg tracking-wide uppercase cursor-pointer border border-dashed dark:border-transparent hover:border-gray-500 transition-all duration-300">
