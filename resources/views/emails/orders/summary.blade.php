...
@section('content')
    ...
    <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">La livraison est assurée par le service <strong>{{ ucfirst($order->shipping->name) }}</strong>.</p>
